with open("src/app/dashboard/student/resume/page.tsx", "r", encoding="utf-8") as f:
    content = f.read()
                        ...
                        return (
                          <div key={key}>
                            <div className="flex justify-between text-xs mb-1">
                              ...
                              <span className="font-bold text-navy">{section.score}/{section.max_score}</span>
                            </div>
                            <div className="w-full bg-gray-200 rounded-full h-2 mb-1">
                              <div
                                className={`h-2 rounded-full ${pct >= 80 ? 'bg-green-500' : pct >= 50 ? 'bg-amber-500' : 'bg-red-500'}`}
...
with open("src/app/dashboard/student/resume/page.tsx", "w", encoding="utf-8") as f:
    f.write(new_ui)
