with open("src/app/dashboard/student/certificates/page.tsx", "r", encoding="utf-8") as f:
    content = f.read()
...
export default function CertificatesPage() {
  ...
  async function handleUpload(e: React.FormEvent) {
    ...
    try {
      await uploadCertificateRequest({ title, issuer, file: file || undefined });
      setTitle("");
      setIssuer("");
      setFile(null);
...
with open("src/app/dashboard/student/certificates/page.tsx", "w", encoding="utf-8") as f:
    f.write(new_ui)
