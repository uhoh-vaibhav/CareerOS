  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-6">
      <form onSubmit={handleSubmit} className="w-full max-w-sm bg-white border border-ice rounded-xl p-6 shadow-sm space-y-4">
        <h1 className="text-2xl font-bold text-navy">Log in to CareerOS</h1>
        <div>
        ...
        <div>
          ...
          <input type="password" required value={password} onChange={(e) => setPassword(e.target.value)} className="w-full border rounded-lg px-3 py-2 text-sm" />
        </div>
